...
const { getStudents, getTutors, getCourses, signupTutor, getCount } = require('../controller/adminController');
...
userRoute.get('/get-courses', authMiddleware, activityMiddleware, getCourses);
userRoute.get('/get-count', authMiddleware, roleMiddleware('Admin'), activityMiddleware, getCount);
